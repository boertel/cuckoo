...
class CuckooTestClient(FlaskClient):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(CuckooTestClient, self).__init__(args[0], response_wrapper=JSONResponseWrapper, **kwargs)
    ...
    def open(self, *args, **kwargs):
        ...
        return super(CuckooTestClient, self).open(*args, **kwargs)
